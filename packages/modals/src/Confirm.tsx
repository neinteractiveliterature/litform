...
import { createContext, useState, useContext, useMemo, useCallback, ReactNode, JSX } from 'react';
import { ConfirmModal } from 'react-bootstrap4-modal';
import { ErrorDisplay } from '@neinteractiveliterature/litform-core';
...
export function useGraphQLConfirm(): ConfirmFunction {
  ...
  const defaultRenderError = useCallback(
    (error: Error) => <ErrorDisplay graphQLError={error} />,
    [],
  );
