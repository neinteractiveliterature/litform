import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{n as p}from"./index-DxaNwTC-.js";import"./index-Ban83id2.js";import"./index-D11W-lyx.js";const v={title:"Forms/BootstrapFormSelect",component:p,argTypes:{label:{control:"text"},hideLabel:{control:"boolean"},helpText:{control:"text"},invalidFeedback:{control:"text"}},parameters:{docs:{description:{component:"A `<select>` tag and a matching `<label>`, styled for Bootstrap.  All normal\n          properties of `<select>` except `onChange` are supported, so you can pass `value={...}`,\n          `className={...}`, etc.  To listen for changes, use `onValueChange`."}}}},c=m=>o.jsxs(p,{...m,children:[o.jsx("option",{value:"1",children:"One"}),o.jsx("option",{value:"2",children:"Two"}),o.jsx("option",{value:"3",children:"Three"}),o.jsx("option",{value:"4",children:"Four"})]}),e=c.bind({});e.args={label:"Bubblegum, bubblegum, in a dish.  How many pieces do you wish?"};const t=c.bind({});t.args={label:"Please do NOT pick a number.",className:"form-control is-invalid",invalidFeedback:"I said don't pick a number!  What is so hard about this."};var a,r,n;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`args => <BootstrapFormSelect {...args}>
    <option value="1">One</option>
    <option value="2">Two</option>
    <option value="3">Three</option>
    <option value="4">Four</option>
  </BootstrapFormSelect>`,...(n=(r=e.parameters)==null?void 0:r.docs)==null?void 0:n.source}}};var s,i,l;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`args => <BootstrapFormSelect {...args}>
    <option value="1">One</option>
    <option value="2">Two</option>
    <option value="3">Three</option>
    <option value="4">Four</option>
